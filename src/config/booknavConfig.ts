...
export const booknavConfig: BooknavGroup[] = [
	...
	},
	{
		...
		items: [
			...
			{
				title: "VoiceCraft（镜像站）",
				url: "https://voicecraft.shake-light.de5.net",
				desc: "【个人搭建】AI驱动的语音处理平台",
			...
			{
				title: "花生下载",
				url: "https://peanutdl.com",
				desc: "下载视频，也搞定日常在线工具",
				icon: "/assets/images/linklogo/peanutdl.png",
				weight: 1,
			},
		],
	},
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				icon: "/assets/images/linklogo/swapp.png",
				weight: 1,
			},
			{
				...
				icon: "/assets/images/linklogo/swhugohelper.png",
				weight: 1,
			},
		],
	},
